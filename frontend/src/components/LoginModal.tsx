...
import { Mail, ShieldCheck, Sparkles, AlertCircle, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-xl">
      <div className="relative w-full max-w-md rounded-3xl bg-gradient-to-b from-[#111827] to-[#0B0F17] border border-slate-800 p-8 shadow-2xl text-center">
        ...
        {/* 1-Click Fast Google Account Direct Sign-In */}
        <div className="space-y-2.5 mt-3 mb-4">
          ...
          >
            ...
            <span>Sign in as <strong className="text-white">anshagar2810@gmail.com</strong></span>
